                  ...
                  <tr key={report._id} className="collector-table-row">
                    ...
                    <td className="collector-table-td action-cell">
                      <div className="collector-action-box">
                        ...
                        <button
                          className={`collector-btn complete-btn ${cleanedImages[report._id] && loadingId !== report._id ? "ready" : ""}`}
                          disabled={!cleanedImages[report._id] || loadingId === report._id}
                          onClick={() => handleComplete(report._id)}
                        >
                          {loadingId === report._id ? "Uploading..." : "Complete"}
                        </button>
